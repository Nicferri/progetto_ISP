...
class MGUK(PowerUnit):
    def __init__(self, budget_MGUK=30000000, dipendenti_MGUK=50):
        super().__init__(budget_MGUK=budget_MGUK,dipendenti_MGUK=dipendenti_MGUK)
    def creaMguk(self, costo):
...
class MGUH(PowerUnit):
    def __init__(self, budget_MGUH=30000000, dipendenti_MGUH=50):
        super().__init__(budget_MGUH=budget_MGUH,dipendenti_MGUH=dipendenti_MGUH)
    def creaMguh(self, costo):
...
class PowerUnitGUI:
    ...
    def creaMguk(self):
        ...
        success, budget_rimanente = self.mguk.creaMguk(costo)
        if success:
    ...
    def creaMguh(self):
        ...
        success, budget_rimanente = self.mguh.creaMguh(costo)
        if success:
